        ...
        <Card className='batch_card coupon' id={coupon.coupon_id}>
            ...
            <Grid item xs={12} sm={4} md={3} zeroMinWidth >
                    <Typography variant="subtitle1" align="center">
                        Owner: <span style={{display:'block'}}>{coupon.customer_name}</span>
                    </Typography>
                </Grid>       
                <Grid item xs={12} sm={4} md={3} zeroMinWidth >
                    <Typography variant="subtitle1" align="center">
                        Category: <span style={{display:'block'}}>{coupon.coupon_type}</span>
                    </Typography>
                </Grid>
                <Grid item xs={12} sm={4} md={3} zeroMinWidth >
                    <Typography variant="subtitle1" align="center">
                       Starts: <span style={{display:'block'}}>{coupon.start_date.split('T')[0]}</span>
                    </Typography>
                </Grid>
                <Grid item xs={12} sm={4} md={3} zeroMinWidth >
                    <Typography variant="subtitle1" align="center">
                        Expires: <span style={{display:'block'}}>{coupon.expiry_date.split('T')[0]}</span>
                    </Typography>
                </Grid>
             </Grid>                               
        </Card>
